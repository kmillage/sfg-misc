...
date: "Insert date or place or other info here"
output:
...
---
`r #This sets the footer for all subsequent slides (or at least until a different layout is specified). Choices for logos are: "sfg-footer-black" or "sfg-footer-color"`
layout: true

<div class="sfg-footer-black"></div> 
...
# Basic content slide with header

This is your pretty basic slide with  text on it. You can make text **bold** or *italic*. You can also insert hyperlinks to websites like [Github](https://github.com/yihui/xaringan). 

If you want to show a chunk of code on your slide it looks like this:
```{r eval=FALSE, tidy=FALSE}
devtools::install_github("yihui/xaringan")
```
But remember to set `eval=FALSE`.

--

If you separate paragraphs with "--" the next paragraph will appear on the click. 

- You can also insert bullet points with a single "-" and footnotes<sup>1</sup>.

.footnote[
[1] Text for your footnotes is put in the `.footnote[]` tag.
]

--

- Bullet points can also be set to appear when you click. 
...
Then maybe you want a paragraph of text on this side too just because you have more things to type here.
]
