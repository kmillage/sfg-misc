...
# Your title goes here... You can make it really long if you want
## Subtitle

```{r title-footer, echo=FALSE, include=TRUE}
### Footer bar across title slide with SFG logo, MSI logo, and Bren logo. Change include to "FALSE" if you don't want to include it. 
div(class = 'footer')
```
