...
background-image: url("./img/title-background-1.jpg")
class: title-slide-dark

# Your title goes here...
### Your subtitle can go here. Or delete this line. 

Author 1, Author 2, Author 3, Author 4... Or delete this line. 

You can also keep adding more text if you really want to.... 

`r div(id='title-footer', img(src='./img/sfg-logo-white.png'), img(src='img/bren-logo-white.png'), img(src='img/msi-logo-white.png'))`
...
Kat Millage, Other Person, Other Person. Or delete this line. 
...
Here's an example of how to position your content in a two column layout: 

.pull-left[
1. Let's say I want an ordered list
...
.pull-right[
* Or maybe I want a bulletted list
  + Sub bullets! 
...
.footnote[[*] Not really. Lame excuse here.]
